...
Deepparse is compatible with the **latest version of PyTorch** and  **Python >= 3.10, <= 3.14**.

.. note::
   On Python 3.13 and 3.14, the ``fasttext`` native library is not available due to C++ compilation issues.
