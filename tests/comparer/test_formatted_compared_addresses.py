...
class TestFormattedComparedAddresses(TestCase):
    ...
    def test_givenIdenticalComparison_thenReturnIdentical(self):
        ...
        raw_identical_comparison = AbstractFormattedComparedAddresses(first_address= self.original_formatted_parsed_address, 
    ...
    def test_givenNotEquivalentComparison_thenReturnNotEquivalent(self):
        ...
        not_equivalent_formatted_address_parsing = FormattedParsedAddress({not_equivalent_address: not_equivalent_address_parsing})
