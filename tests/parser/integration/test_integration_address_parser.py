...
from tests.parser.integration.base_predict import AddressParserPredictBase, AddressParserPredictBaseGPU


@skipIf(not torch.cuda.is_available(),
        "no gpu available")  # We still skip when no GPU since too long download for runner
class AddressParserPredictTestCPU(AddressParserPredictBase):
...
class AddressParserPredictTestGPU(AddressParserPredictBaseGPU):
