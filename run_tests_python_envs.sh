...
# We test on Deepparse supported Python versions, namely, 3.8, 3.9, 3.10, 3.11 and 3.12
echo "*****Starting of testing Deepparse on Python version 3.8, 3.9, 3.10, 3.11, 3.12*****"
